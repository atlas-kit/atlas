...
BLESS_FLAG_ADVENTURER = 1 -- not supported
BLESS_FLAG_TWIST_OF_FATE = 2 -- not supported
BLESS_FLAG_WISDOM_OF_SOLITUDE = 4
BLESS_FLAG_SPARK_OF_PHOENIX = 8
BLESS_FLAG_FIRE_OF_THE_SUNS = 16
BLESS_FLAG_SPIRITUAL_SHIELD = 32
BLESS_FLAG_THE_EMBRACE_OF_THE_WORLD = 64
BLESS_FLAG_HEART_OF_MOUNTAIN = 128 -- not supported
BLESS_FLAG_BLOOD_OF_MOUNTAIN = 256 -- not supported
