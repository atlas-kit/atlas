...
function Game.getBlessings()
	return {
		[1] = BLESSING_FLAG_WISDOM_OF_SOLITUDE,
		[2] = BLESSING_FLAG_SPARK_OF_PHOENIX,
		[3] = BLESSING_FLAG_FIRE_OF_THE_SUNS,
		[4] = BLESSING_FLAG_SPIRITUAL_SHIELD,
		[5] = BLESSING_FLAG_THE_EMBRACE_OF_THE_WORLD
	}
end
