...
function Game.getBlessings()
	return {
		[1] = BLESS_FLAG_WISDOM_OF_SOLITUDE,
		[2] = BLESS_FLAG_SPARK_OF_PHOENIX,
		[3] = BLESS_FLAG_FIRE_OF_THE_SUNS,
		[4] = BLESS_FLAG_SPIRITUAL_SHIELD,
		[5] = BLESS_FLAG_THE_EMBRACE_OF_THE_WORLD
	}
end
