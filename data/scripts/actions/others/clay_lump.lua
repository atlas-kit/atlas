local config = {
	{chance = {0.0, 1.54}, transformId = 9508, description = "This little figurine of Brog, the raging Titan, was skillfully made by |PLAYERNAME|.", achievement = true},
	{chance = {1.54, 9.16}, transformId = 9507, description = "It was made by |PLAYERNAME| and is clearly a little figurine of.. hm, one does not recognise that yet."},
	{chance = {9.16, 25.48}, transformId = 9506, description = "It was made by |PLAYERNAME|, whose potter skills could use some serious improvement."},
