...
local foods = {
	...
	[21143] = {15, "Munch."}, -- glooth sandwich
	[21144] = {7, "Slurp."}, -- bowl of glooth soup
	[21145] = {6, "Burp."}, -- bottle of glooth wine
	[21146] = {25, "Chomp."}, -- glooth steak
	[22185] = {12, "Yum."}, -- prickly pear
	[22187] = {60, "Chomp."}, -- roasted meat
	[23535] = {25, "Mmmm."}, -- energy bar
	[23545] = {15, "Mmmm."}, -- energy drink
	[24382] = {20, "Urgh."}, -- bug meat
	[24383] = {10, "Gulp."}, -- cave turnip
	[24396] = {60, "Mmmm."}, -- birthday cake
	[24439] = {4, "Slurp."}, -- shell
	[24948] = {10, "Slurp."}, -- bottle of Wine
	[25692] = {15, "Mmmmm!"}, -- fresh fruit
	[30198] = {40, "Mmmm."}, -- meringue cake
