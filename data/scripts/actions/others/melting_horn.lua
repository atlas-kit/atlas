...
function meltingHorn.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if target.itemid == 18077 or target.itemid == 18078 or target.itemid == 18079 then
		if math.random(100) > 32 then
			...
			elseif target.itemid == 18078 then
			...
			elseif target.itemid == 18079 then
