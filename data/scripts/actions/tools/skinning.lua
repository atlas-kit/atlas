local config = {
	[5908] = {
		...
		-- High Class Lizards
		[10368] = {chance = 9087, newItem = 5876, after = 10369}, -- lizard chosen,
		[10371] = {chance = 9087, newItem = 5876, after = 10369}, -- lizard chosen, after being killed
		[10360] = {chance = 9087, newItem = 5876, after = 10361}, -- lizard dragon priest
		[10363] = {chance = 9087, newItem = 5876, after = 10361}, -- lizard dragon priest, after being killed
		[10352] = {chance = 9087, newItem = 5876, after = 10353}, -- lizard high guard
		[10355] = {chance = 9087, newItem = 5876, after = 10353}, -- lizard high guard, after being killed
		[10364] = {chance = 9087, newItem = 5876, after = 10365}, -- lizard zaogun
		[10367] = {chance = 9087, newItem = 5876, after = 10365}, -- lizard zaogun, after being killed

		-- Dragon
		[4286] = {chance = 4999, newItem = 5877, after = 4287},
		[5973] = {chance = 4999, newItem = 5877, after = 4287}, -- after being killed

		-- Dragon Lord
		[4062] = {chance = 4999, newItem = 5948, after = 4063},
		[5984] = {chance = 4999, newItem = 5948, after = 4063}, -- after being killed

		-- Behemoth
		[4112] = {chance = 9087, newItem = 5893, after = 4113},
		[5999] = {chance = 9087, newItem = 5893, after = 4113}, -- after being killed
		...
		-- Clomp
		[22743] = {chance = 50000, newItem = 22186, after = 22744},
		[22742] = {chance = 50000, newItem = 22186, after = 22744}, -- after being killed
		...
		[10426] = {
			...
			{chance = 8684, newItem = 10428, desc = "This little figurine made by |PLAYERNAME| has some room for improvement."},
			{chance = 21631, newItem = 10427, desc = "This shoddy work was made by |PLAYERNAME|."}
		},

		-- Ice Cube
		[7441] = {chance = 27344, newItem = 7442},
		[7442] = {chance = 16720, newItem = 7444},
		[7444] = {chance = 9087, newItem = 7445},
		[7445] = {chance = 7000, newItem = 7446},

		-- The Mutated Pumpkin
		[8133] = {
			{chance = 4999, newItem = 8032}, -- spiderwebs
			{chance = 4999, newItem = 8178}, -- toy spider
			{chance = 4999, newItem = 6491}, -- bat decoration
			{chance = 50000, newItem = 6525}, -- skeleton decoration
			{chance = 50000, newItem = 8177, amount = 20}, -- yummy gummy worm
			{chance = 4999, newItem = 6570}, -- surprise bag (red)
			{chance = 50000, newItem = 6571}, -- surprise bag (blue)
			{chance = 50000, newItem = 6574}, -- bar of chocolate
			{chance = 50000, newItem = 2977}, -- pumpkinhead
			{chance = 50000, newItem = 3594}, -- pumpkin
			{chance = 50000, newItem = 3599, amount = 50}, -- candy cane
			{chance = 50000, newItem = 6569, amount = 50} -- candy
		},
	},
	[5942] = {
		-- Demon
		[4097] = {chance = 4181, newItem = 5906, after = 4098},
		[5995] = {chance = 4181, newItem = 5906, after = 4098}, -- after being killed
...
function skinning.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if type(skin[1]) == "table" then
		...
		for _, skinChild in ipairs(skin) do
			if randomChance <= skinChild.chance and not target.itemid == 4427 then
				if target.itemid == 9509 then
		...
		if not added and target.itemid == 9509 then
			effect = CONST_ME_HITAREA
