...
INSERT INTO `server_config` (`config`, `value`) VALUES ('db_version', '39'), ('players_record', '0');
...
-- Create Sample Account and Players
INSERT INTO `accounts`
(`id`, `name`, `email`, `password`, `type`) VALUES
(1, 'atlas', '@atlas', 'ece8f46bf734ca267a2b6e0f7c3b471a5c964428', 6);
...
(6, 'Administrator', 6, 1, 2, 0, 155, 155, 100, 113, 115, 95, 39, 75, 0, 60, 60, 0, 1, '', 410, 1, 10, 0, 10, 0, 10, 0, 10, 0);
