...
BOOST_AUTO_TEST_CASE(test_check_password_invalid_characters_field_true_for_printable_chars)
{
	auto&& body = routes::handle_check_password({{"password1", "Pass!@#"}}, ip);
	auto reqs = body.at("PasswordRequirements").as_object();
...
BOOST_AUTO_TEST_CASE(test_check_password_invalid_characters_field_false_for_non_printable_chars)
{
