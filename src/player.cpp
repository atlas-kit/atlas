...
void Player::setFightModes(FightMode_t mode, bool chase, bool secure)
{
	...
	tfs::events::player::onFightModesChanged(asPlayer(), previousFighting.mode, previousFighting.chase,
